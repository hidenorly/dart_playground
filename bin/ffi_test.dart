...
typedef NativeCFunc = Void Function(Int64, Pointer<NativeFunction<Void Function(Int64, Int32)>>);
typedef NativeCFuncDart = void Function(int, Pointer<NativeFunction<Void Function(Int64, Int32)>>);
final NativeCFuncDart nativeCFunc = nativeLib.lookup<NativeFunction<NativeCFunc>>("native_c_func").asFunction();

// define callback (this is called from native)
...
void main() async {
    ...
    nativeCFunc(receivePort.sendPort.nativePort, callbackPointer);
}
